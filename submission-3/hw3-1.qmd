...
knitr::kable(regression_table, 
             col.names=c("OLS","Coefficients","Standard Error"),
...
knitr::kable(regression_table2, 
             col.names=c("IV","Coefficients","Standard Error"),
             format.args=list(big.mark=","), booktabs = TRUE) 
...
options(knitr.kable.NA = 0)
knitr::kable(regression_table3, 
             col.names=c("First Stage","Coefficients","Standard Error"),
             format.args=list(big.mark=","), booktabs = TRUE)
```
...
options(knitr.kable.NA = 0)
knitr::kable(regression_table4, 
             col.names=c("Reduced Form","Coefficients","Standard Error"),
             format.args=list(big.mark=","), booktabs = TRUE)
```
...
The elasticity estimates are different between the years. This makes sense since there have been health campaigns against smoking that can cause the demand to go down, even though cigarettes have an addictive element. 